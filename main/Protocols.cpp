...
void Protocols::sendNmeaPBELB( float empty_kg, float crew_kg, float water_kg, float max_ballast_kg, float wingarea_m2, float iasKmh, float speaker_volume ) {
/*
...
*/
	char str[60];
	sprintf( str,"$PBELB,%1.0f,%1.0f,%1.0f,%1.0f,%1.2f,%.2f,%.0f,,", empty_kg, crew_kg, water_kg, max_ballast_kg, wingarea_m2, iasKmh, speaker_volume);
